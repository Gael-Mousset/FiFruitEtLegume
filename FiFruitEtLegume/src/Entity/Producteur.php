...
class Producteur
{
    ...
    {
        return $this->nom_de_l_entreprise;
    }

    public function setNomDeLEntreprise(?string $nom_de_l_entreprise): self
    {
        $this->nom_de_l_entreprise = $nom_de_l_entreprise;
